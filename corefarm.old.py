...
class StaticFarm(object):
	...
	def render(self, xml_light, xml):
		try:
			...
			if job_id:
				...
				datafile = self._traverse_data(job_id, xml_light)
	...
	def _traverse_data(self, job_id, xml_filename):
		...
		files = [
			(relative_xml_filename, base_xml_filename)
		]
